...
const test_support_1 = require("@appium/test-support");
...
describe('UiAutomator2', function () {
    ...
    describe('shouldUninstallServerPackages', function () {
        ...
        it('with newer servers are installed', function () {
            ...
            (0, chai_1.expect)(uiautomator2.shouldUninstallServerPackages([
                {
    ...
    describe('shouldInstallServerPackages', function () {
        ...
        it('with newer servers are installed', function () {
            // @ts-expect-error - private method
            (0, chai_1.expect)(uiautomator2.shouldInstallServerPackages([
                {
                    'installState': adb.APP_INSTALL_STATE.NEWER_VERSION_INSTALLED,
                    ...serverApk
                },
    ...
    describe('installServerApk', (0, test_support_1.withMocks)({ adb, helpers }, (mocks) => {
        beforeEach(function () {
            uiautomator2 = new uiautomator2_1.UiAutomator2Server(logger_1.default, {
                adb, ...defaultUIA2ServerOptions
            });
